 ...
 * @author jeroen
 */
public class EntityReaderTrec_1112 extends RepIREntityReader {

   public static Log log = new Log(EntityReaderTrec_1112.class);
   ...
   public boolean nextKeyValue() {
      if (fsin.hasMore()) {
         if (readUntilStart() && fsin.getOffset() - startTag.length < fsin.getCeiling()) {
            ...
            if (readEntity()) {
               entitywritable.entity.addSectionPos("all", 0, 0, entitywritable.entity.content.length, entitywritable.entity.content.length);               return true;
            }
         }
      }
      return false;
