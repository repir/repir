 ...
 * @author jbpvuurens
 */
public class RemoveColonQuery extends ExtractorProcessor {

   public static Log log = new Log(RemoveColonQuery.class);
   public ByteRegex open = new ByteRegex("<NUM>");
   public ByteRegex close = new ByteRegex("</NUM>");

   public RemoveColonQuery(Extractor extractor, String process) {
