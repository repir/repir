...
// * @author jer
// */
//public class TopicReaderSession extends StructuredTextfileTagUnordered implements TopicReader {
//
//   public static Log log = new Log(TopicReaderSession.class);
...
//
//   public TopicReaderSession(Datafile df) {
//      super(df);
//   }
//
//   public TopicReaderSession(Repository repository) {
...
//   }
//
//   public class currentquery extends StringField {
//
//      public currentquery() {
//         super("currentquery");
...
//      return new ByteRegex("<session.*?>");
//   }
//
//   @Override
//   public ByteRegex createEndRecordRegex(Field f) {
//      return new ByteRegex("</session>\\s*");
//   }
//
//   @Override
