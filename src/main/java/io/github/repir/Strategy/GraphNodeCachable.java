...
/**
 * A GraphNodeCachable is a node that requires additional data to the data that
 ...
 * <p/>
 */
public abstract class GraphNodeCachable extends GraphNode {

   protected GraphNodeCachable(GraphRoot root) {
      super(root);
   }

   protected GraphNodeCachable(Repository repository) {
      super(repository);
   }
