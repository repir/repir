...
public class SynonymOperator extends CachableOperator {
  ...
  /**
   ...
   public String postReformUnweighted() {
      ...
      sb.append("[");
      if (getCF() > -1) {
         sb.append(io.github.htools.lib.PrintTools.sprintf("cf=%d ", getCF()));
      }
      if (getDF() > -1) {
         sb.append(io.github.htools.lib.PrintTools.sprintf("df=%d ", getDF()));
      }
      for (Operator f : containednodes) {
   ...
   public String toString() {
      return io.github.htools.lib.PrintTools.sprintf("FeatureSynonym[%d] weight %f\n", this.containednodes.size(), this.getQueryWeight());
   }
}
